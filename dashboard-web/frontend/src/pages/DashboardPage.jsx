    ...
    <div className="min-h-screen bg-canvas-secondary lg:pl-64 flex flex-col transition-all duration-300">
      ...
      <main className="flex-1 p-6 lg:p-8 overflow-auto">
        <div className="max-w-screen-xl mx-auto w-full">
          ...
          {location.pathname === '/activity' && <ActivityView />}
          {location.pathname === '/metrics' && <MetricsView />}
          {location.pathname === '/analysis' && <AnalysisView />}
          {location.pathname === '/calls' && <CallsView />}
          {location.pathname === '/providers' && <ProvidersView />}
          {location.pathname === '/performance' && <PerformanceView />}
        </div>
      </main>
    </div>
  );
